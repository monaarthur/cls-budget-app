    ...
    public partial class AddIdentityAndTenants : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000001"), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), true, "MonaArthur" });

            migrationBuilder.CreateIndex(
                name: "IX_AppUser_TenantId_Email",
                table: "AppUser",
