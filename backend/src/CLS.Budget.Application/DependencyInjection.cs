...
public static class DependencyInjection
{
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddSingleton<IInterestCalculationEngine, InterestCalculationEngine>();
        services.AddSingleton<IUtilizationEngine, UtilizationEngine>();
        services.AddSingleton<IPayoffStrategyEngine, PayoffStrategyEngine>();
